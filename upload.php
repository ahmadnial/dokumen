                ...
                <div class="card-body row g-2">
                    <div class="col-md mb-3">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-2 mt-3">
                                <label for="" class="form-label">Unit / Ins. / Bagian Pemilik Dokumen</label>
                            ...
                            <div class="mb-2 mt-2">
                                ...
                                <input type="text" class="form-control" name="nama_dokumen" placeholder="Tuliskan Nama SPO" required>
                            </div>

                            <div class="mb-2 mt-2">
                                <label for="" class="form-label">Nomor Dokumen</label>
                                <input type="text" class="form-control" name="no_dokumen" placeholder="Tuliskan Nama SPO" required>
                            </div>
                            ...
                            <textarea class="form-control" name="keterangan" id="" rows="2"></textarea>
