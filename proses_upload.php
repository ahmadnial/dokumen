...
if ($_POST['upload']) {
    ...
    $unit = $_POST['unit'];
    $nm_spo = $_POST['nama_dokumen'];
    $nospo = $_POST['no_dokumen'];
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        if ($ukuran < 1890000000000000) {
            ...
            $sql = "INSERT INTO document_rs_spo (jenis_dokumen,unit,tanggal,nama_file,file_nama,status,no_spo,tanggal_verif)
            VALUES ('$jenis_dokumen','$unit','$tgl1','$nm_spo','$nama','$ket','$nospo','$tgl2')";
